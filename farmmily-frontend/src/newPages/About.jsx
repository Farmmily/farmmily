          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <div className="text-center">
                <img
                  src="https://placehold.co/200x200/a3e635/ffffff?text=Director"
                  alt="A. Vijayakumar"
                  className="w-40 h-40 rounded-full mx-auto mb-4 shadow-lg"
                />
                <h3 className="text-2xl font-bold">A. Vijayakumar</h3>
                <p className="text-gray-500 font-semibold mb-4">
                  Director & Chief Technical Strategist
                </p>
                <p className="text-gray-600 text-left">
                  A. Vijayakumar is the foundational pillar of technical and
                  strategic expertise at Farmmily. His distinguished 40-year
                  career, culminating as a retired Superintendent Engineer from
                  the Agricultural Engineering Department, Tamil Nadu, provides
                  an unparalleled depth of field-tested knowledge. He is the
                  guiding force behind the company's operational excellence,
                  with a career marked by the successful completion of over 100
                  projects, including the field-level execution of major
                  government initiatives. This practical wisdom is the bedrock
                  of Farmmily's on-the-ground success. He possesses a profound
                  depth of knowledge in agricultural farm mechanisation,
                  innovative machinery development, and excels at deploying his
                  problem-solving skills to overcome complex technical
                  challenges. His strategic vision and profound field presence
                  are indispensable to the company's success.
                </p>
              </div>
              <div className="text-center">
                <img
                  ...
                  className="w-40 h-40 rounded-full mx-auto mb-4 shadow-lg"
                />
                <h3 className="text-2xl font-bold">Sibi Selvan C</h3>
                <p className="text-gray-500 font-semibold mb-4">
                  Director & Founder
                </p>
                <p className="text-gray-600 text-left">
                  Sibi Selvan C is the entrepreneurial engine and Director of
                  Farmmily, leading the company's strategic business
                  development. His professional focus is centered on a
                  relentless drive for exploring diverse business opportunities
                  and pioneering innovative agricultural models. This
                  entrepreneurial mindset ignited at age 15 with his first
                  venture selling tender coconuts, a foundation later built upon
                  with a Mechanical Engineering degree from PSG College of
                  Technology. He founded Farmmily at 22, driven by a vision to
                  architect high-yield, sustainable agricultural portfolios from
